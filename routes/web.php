...
Route::post('/save-appointment', [AppointmentController::class, 'save'])->name('save.appointment');
...
Route::get('/doctor/dashboard',function(){
    return view('Doctor.dashboard') ; //redirecting to login page if user directly hit dashboard url
});
